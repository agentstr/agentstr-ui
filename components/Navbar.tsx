            ...
            {navigation.map((item) => 
              item.external ? 
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block px-3 py-2 rounded-md text-base font-medium text-gray-800 dark:text-gray-300 hover:text-foreground hover:bg-gray-800 flex items-center justify-between"
                >
